...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <a class="navbar-brand" href="../">Game plus</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link active" style="font-weight: bold;size: 50px;" aria-current="page" href="../admin/">Nouveau</a>
        </li>
        <li class="nav-item">
      ...
      <div style="margin-right: 500px">
        <!-- <h5 style="color: red ; opacity: 0.5;">Connecté en tant que: <?= $id ?></h5> -->
      </div>
